...
<head runat="server">
    ...
    <style>
        ...
        .form-group label { font-weight: 500; color: #555; margin-bottom: 6px; display: block; }
        .form-control, .form-control-file {
            border-radius: 4px; border: 1px solid #ccc; padding: 10px 15px; font-size: 16px;
            box-shadow: none; transition: border-color 0.3s ease;
        }
        .form-control:focus, .form-control-file:focus { border-color: #f4a261; outline: none; box-shadow: 0 0 5px rgba(244,162,97,0.6); }
        .btn-submit {
            background-color: #f4a261; border-color: #f4a261; color: #fff; font-weight: 600;
            padding: 12px 25px; border-radius: 5px; font-size: 16px; border-style: solid; border-width: 1.5px; cursor: pointer;
        }
        .btn-submit:hover { background-color: #e07b40; border-color: #e07b40; }
        #lblAddStatus, #lblDeleteStatus { font-size: 14px; margin-top: 12px; display: block; color: #d9534f; }
        .table img { max-width: 100px; max-height: 80px; border-radius: 6px; }
    </style>
</head>
<body>
        ...
        <div class="container mt-4">
            ...
            <div class="form-section">
                ...
                <asp:GridView ID="gvMenuItems" runat="server"
                    ...
                    OnPageIndexChanging="gvMenuItems_PageIndexChanging">
                    <Columns>
    ...
    <!-- Optional JS (if your admin template needs it) -->
