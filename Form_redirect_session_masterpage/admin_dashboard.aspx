<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_dashboard.aspx.cs" Inherits="Form_redirect_session_masterpage.admin_dashboard" %>
...
<body id="reportsPage">
                    ...
                    <ul class="navbar-nav mx-auto h-100">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="testimonial_admin.aspx">Reviews</a>
    ...
    <!-- You can keep the rest of your page content unchanged below -->
                    ...
                    <div class="tm-notification-items">
                        <div class="media tm-notification-item">
                            <div class="tm-gray-circle">
                                <img src="img/notification-01.jpg" alt="Avatar Image" class="rounded-circle"></div>
                        ...
                        <div class="media tm-notification-item">
                            <div class="tm-gray-circle">
                                <img src="img/notification-02.jpg" alt="Avatar Image" class="rounded-circle"></div>
                            <div class="media-body">
                                <p class="mb-2">
                        ...
                        <div class="media tm-notification-item">
                            <div class="tm-gray-circle">
                                <img src="img/notification-03.jpg" alt="Avatar Image" class="rounded-circle"></div>
                            <div class="media-body">
                                <p class="mb-2">
